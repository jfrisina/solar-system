...
console.log("Solar System: Part 1-------------------------------------------------------------------")
...
console.log("Print the array of Jupiter's moons:")
console.log(solarSystem[4].moons);

// 2. Print the name of Neptune's moon "Nereid" to the console.
console.log("Print the name of Neptune's moon Nereid:")
console.log(solarSystem[7].moons[1]);


// 3. Add a new moon called "Endor" to Venus' moons array.
console.log("Add a new moon called Endor to Venus' moons array:")
let addMoon = solarSystem[1].moons.push("Endor");
...
console.log("Add a Pluto object to the solarSystem array:")
...
console.log("Add a new key value pair to the the Earth object:")
let addKeyValue = solarSystem[2].diameter = "15 miles";
console.log(addKeyValue)


// 6. Change Mercury's ringSystem boolean to true.
console.log("Change Mercury's ringSystem boolean to true:")
let changeBool = solarSystem[0].ringSystem = "true";
console.log(solarSystem[0].ringSystem);


// 7. Change Uranus' moon "Umbriel" to "Oberon"
console.log("Change Uranus' moon Umbriel to Oberon:")
let changeMoon = solarSystem[6].moons[3] = "Oberon"
...
console.log("Iterate through the solarSystem array and print only the objects that have a ringSystem:")
...
const system = {
    ...
    console.log("Print the mass of Mercury:")
    console.log(system.mercury.mass);
     
    // 2. console.log the eccentricity of Venus
    console.log("Print the eccentricity of Venus:")
    ...
    console.log("Print the sum of the number of satellites of Jupiter, Saturn, Uranus, and Neptune:")
    let sumSatellites = system.jupiter.satellites + system.saturn.satellites + system.uranus.satellites + system.neptune.satellites
    console.log(sumSatellites) 

    // 4. Write a conditional that checks if Mercury's radius is a string (remember the typeof command). If Mercury's radiusp is a string, change the value to be the same as its radiuse value. (radiusp is radius at the poles, radiuse is radius at the equator).
    console.log("Check if Mercury's radius is a string:")
    console.log(typeof system.mercury.radiusp);
    
    // 5. console.log Mercury's radius (should be 2439, not 'same').
    console.log("Print Mercury's radiusp:")
    ...
    console.log("Print the difference between Jupiter's momentum and Pluto's momentum:")
